...
const Focos = () => {
    ...
    return (
        <div>
            ...
            <table>
                <tr>
                    <td><img src={getImage(1)} alt="foco"  onClick={() => updateFoco1(foco => !foco)}/></td>
                    <td><img src={getImage(2)} alt="foco"  onClick={() => updateFoco2(foco => !foco)}/></td>
                    <td><img src={getImage(3)} alt="foco"  onClick={() => updateFoco3(foco => !foco)}/></td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    <td><img src={getImage(4)} alt="foco"  onClick={() => updateFoco4(foco => !foco)}/></td>
                    <td><img src={getImage(5)} alt="foco"  onClick={() => updateFoco5(foco => !foco)}/></td>
                    <td><img src={getImage(6)} alt="foco"  onClick={() => updateFoco6(foco => !foco)}/></td>
                </tr>
                <tr>
